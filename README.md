...
4. **Object Detection (Obstacle Detection)** – Detects nearby objects with a YOLO11n model and turns them into voice-friendly proximity warnings (English + Arabic)
5. **Roshdi Mobile App** – A Flutter app that bundles all four models and runs them offline on the phone
...
For full details, see [Face Recognition/README.md](https://github.com/MazenBasha/-Roshdi-graduation-project-/blob/main/Face%20Recognition/README.md).
...
| --- | ------- | ----- | --- | -------- | ----- |
| 0  | 1\_EGP  | 1     | 4  | 50\_EGP  | 50    |
| 1  | 5\_EGP  | 5     | 5  | 100\_EGP | 100   |
| 2  | 10\_EGP | 10    | 6  | 200\_EGP | 200   |
| 3  | 20\_EGP | 20    |    |          |       |
...
For full details, see [Egyptian Currency Detection/README.md](https://github.com/MazenBasha/-Roshdi-graduation-project-/blob/main/Egyptian%20Currency%20Detection/README.md).
...
For full details, see [Voice commands/README.md](https://github.com/MazenBasha/-Roshdi-graduation-project-/blob/main/Voice%20commands/README.md).
...
For full details, see [Object Detection/README_LOCAL_TEST.md](https://github.com/MazenBasha/-Roshdi-graduation-project-/blob/main/Object%20Detection/README_LOCAL_TEST.md).
...
| **ML Modules**      | 4 — Face Recognition, Currency Detection (YOLOv8), Voice Commands, Object Detection (YOLO11n) |
| **App**             | Flutter cross-platform mobile/desktop (`rushdey/`)                                            |
| **Frameworks**      | PyTorch, Ultralytics YOLOv8 / YOLO11, TensorFlow/Keras, Flask, Flutter                        |
