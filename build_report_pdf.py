"""Convert Report2_Week12_FaceRecognition.md -> styled HTML -> PDF (via Chrome headless)."""
import subprocess
import sys
...
MD_PATH = ROOT / "Report2_Week12_FaceRecognition.md"
HTML_PATH = ROOT / "Report2_Week12_FaceRecognition.html"
PDF_PATH = ROOT / "Report2_Week12_FaceRecognition.pdf"
...
strong { color: #111; }
.title-meta td { background: #fafbfd; }
...
<html lang="en"><head>
<meta charset="utf-8">
<title>Roshdi - Face Recognition - Report 2 (Week 12)</title>
<style>{CSS}</style>
